package cn.phoenixuzoo.statisticservice.domain;

import java.math.BigDecimal;

import static java.lang.Integer.parseInt;

public class FinanceProductItem implements Comparable<FinanceProductItem>{
    ...
    @Override
    public int compareTo(FinanceProductItem o) {
